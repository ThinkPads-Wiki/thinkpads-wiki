...
> This multi-billion US dollar negotiation (which also included a low-end server business, sold by IBM) has seemingly paid off, making the Chinese multinational-corporation a household name. By many, Lenovo is considered to be dedicated and similar in spirit to the original IBM vision -- in their loyalty and acknowledgement of the ThinkPad's roots -- and through innovative yet tradition-preserving design features & machine build-quality.
