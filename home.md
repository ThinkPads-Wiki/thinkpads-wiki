...
### IBM
Placeholder description with redirect to [IBM ThinkPads](../wiki/ThinkPads/IBM) 
...
## Buyer's Guide
## Timeline
Placeholder description with redirect to the [timeline](http://thinkpads.wiki/tools-and-references/timeline)
